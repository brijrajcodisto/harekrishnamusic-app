...
import 'package:Harekrishnamusic/CustomWidgets/artist_like_button.dart';
import 'package:Harekrishnamusic/CustomWidgets/bouncy_sliver_scroll_view.dart';
...
import 'package:Harekrishnamusic/CustomWidgets/playlist_popupmenu.dart';
...
class _ArtistSearchPageState extends State<ArtistSearchPage> {
  ...
  Widget build(BuildContext context) {
    if (!status) {
      ...
      SaavnAPI()
          .fetchArtistSongs(
        artistToken: widget.data['artistId'].toString(),
        category: category,
        sortOrder: sortOrder,
      )
          .then((value) {
